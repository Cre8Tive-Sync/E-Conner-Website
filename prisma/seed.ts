...
async function main() {
  ...
  await prisma.tourismSpot.createMany({
    data: [
      {
        name: 'Apayao-Abulug River',
        description: 'A majestic river flowing through Conner, part of the UNESCO-listed Apayao Biosphere Reserve.',
        icon: '🏔️',
        order: 0,
      },
      {
        name: 'Natural Springs',
        description: 'Cool, clear springs nestled in the mountains of Conner, accessible via scenic forest trails.',
        icon: '💧',
        order: 1,
      },
      {
        name: 'Dipterocarp Forest',
        description: 'Home to lawaan trees, Rafflesia flowers, and critically endangered wildlife of the Cordillera.',
        icon: '🌳',
        order: 2,
      },
    ],
  ...
  await prisma.official.createMany({
    data: [
      ...
      { name: 'Hon. [Vice Mayor]', position: 'Vice Mayor', badge: null, order: 1 },
      { name: 'Hon. [Councilor 1]', position: 'SB Member', badge: null, order: 2 },
      { name: 'Hon. [Councilor 2]', position: 'SB Member', badge: null, order: 3 },
      { name: 'Hon. [Councilor 3]', position: 'SB Member', badge: null, order: 4 },
      { name: 'Hon. [Councilor 4]', position: 'SB Member', badge: null, order: 5 },
    ],
  });
